export function AIBrowserAssistantLeftSidebar({ project }) {
  return (
    ...
    <div className="side-card">
        ...
        <a className="side-link" href="https://www.youtube.com/watch?v=BCg4U1FzODs" target="_blank" rel="noreferrer">
        ...
        <a className="side-link" href="https://youtu.be/GGi7Brsf7js?t=107" target="_blank" rel="noreferrer">
  ...
  return (
    ...
    <div className="side-card">
        ...
        <p className="side-muted">
          Extension users will need to input their own 
          unique API key through the extension's 
          settings menu, accessible in the top right 
          hand corner of the sidebar. API keys 
          are not meant to be shared between users.
        </p>
    </div>
    <div className="side-card">
        <h3>TO-DO LIST</h3>
