  ...
  return (
    <>
      ...
      <div className="side-card">
        ...
        <a
          className="side-link"
          href="https://www.youtube.com/watch?v=9Yh3LlYlAyo&list=PLEyTwruuVAqmERIfwYD6IWnTracuzigH9&index=5a"
          target="_blank"
          rel="noreferrer"
        >
          ▶️JSON Save+Load
        ...
        <a
          className="side-link"
          href="https://www.youtube.com/watch?v=E8xaV6fiTaA"
          target="_blank"
          rel="noreferrer"
        >
          ▶️Vercel Deployment
        ...
        <a
          className="side-link"
          href="https://www.youtube.com/watch?v=e5xUcr_wv4E"
          target="_blank"
          rel="noreferrer"
        >
          ▶️Custom Domain
  ...
  return (
    <>
      <div className="side-card">
        <h3>Notes</h3>
        <p className="side-muted">
          Cookie Clicker was a childhood favorite, so I built Pineapple Puncher
          as a nostalgic excuse to practice React, state management, and
      ...
      <div className="side-card">
        ...
        <a
          className="side-link"
          href="https://pineapplepuncher.garrettstevenmorgan.com"
          target="_blank"
        >
          🍍🥊Pineapple Puncher
        </a>
